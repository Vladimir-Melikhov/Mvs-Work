<!-- frontend/src/components/AiDealWizard.vue -->
<template>
    ...
    <div class="bg-white rounded-[32px] p-6 md:p-8 md:pr-6 max-w-2xl w-full shadow-2xl relative border border-white/50 max-h-[90vh] overflow-y-auto custom-scrollbar">
      ...
      <div v-if="step === 3">
        ...
        <div class="mb-6">
          ...
          <div v-if="!editing" class="bg-gray-50 border border-gray-200 rounded-2xl p-4 md:p-6 max-h-[300px] overflow-y-auto custom-scrollbar">
